...
canvas.addEventListener('mouseout', () => {
  ...
  const update = () => {
    ...
    if (intersects.length > 0) {
      ...
      if (intersectedObject.isMesh && !isObjectSelected && intersectedObject.name != 'int29' && intersectedObject.name != 'Bar' && intersectedObject.name != 'InfoPoint' && intersectedObject.name != 'WC' && intersectedObject.name != 'Ingresso_Nord001' && intersectedObject.name != 'Ingresso_Nord' && intersectedObject.name != 'Ingresso_Padiglione_28' && intersectedObject.name != 'Plane' && intersectedObject.name != 'Plane_1') {
